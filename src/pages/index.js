      ...
      <main className={styles.landingSection}>
        <section>
          ...
          <div className='m-auto p-auto'>
            <Link className='pe-2' target='_blank' href='https://www.linkedin.com/in/makyiabonner/' id='LinkedIn'>
            ...
            <Link className='pe-2' target='_blank' href='https://github.com/makyiabonner' id='Github'>
            ...
            <Link className='pe-2' target='_blank' href='https://docs.google.com/document/d/1aiLKdgDUF3-jUGbIXilmyvPXX4_fxPgmV409h_utTKg/edit?usp=sharing' id='Resume'>
